	...
	stage('Build and push') {
			...
			git url:"https://github.com/satthya/Guvi_Project.git",branch: "dev"
                        ...
                        withCredentials([usernamePassword(credentialsId:"Docker",passwordVariable:"dockerhubpass",usernameVariable:"dockerhubuser")]){
                            sh "docker tag react_application satthya_57@hotmail.com/prod:latest ${env.dockerhubuser}/dev:latest "
			...
			git url:"https://github.com/satthya/Guvi_Project.git",branch: "main"
                        ...
                        withCredentials([usernamePassword(credentialsId:"Docker",passwordVariable:"dockerhubpass",usernameVariable:"dockerhubuser")]){
                            sh "docker tag react_application satthya_57@hotmail.com/prod:latest ${env.dockerhubuser}/prod:latest "
			    sh "docker login -u ${env.dockerhubuser} -p ${env.dockerhubpass}"
